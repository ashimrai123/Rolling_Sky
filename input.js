...
const speed = 0.15;
  ...
  function handleKeys() {
    ...
    if (keys['ArrowRight']) {
      ...
      else if(increasingSpeedXright >= maxSpeeding && increasingSpeedXright <= maxSpeeding + 0.004) // to keep making the ball in maximum speed 
      {
  ...
  else{  // When up arrow released, we still have to move a little 
    if(increasingSpeedXright > speedX ){ //X for X-axis  
...
//FOR ROTATION ---------------------------------------------------------------------------------------
  ...
  /*---------------------------------------------------- ARROW LEFT ----------------------------------------------------------------------*/
    ...
    if (keys['ArrowLeft']) {
      ...
      else if(increasingSpeedXleft >= maxSpeeding && increasingSpeedXleft <= maxSpeeding + 0.004) // to keep making the ball in maximum speed 
      {
    ...
    if(increasingSpeedXleft > speedX ){ //X for X-axis 
...
/*---------------------------------------------------- ARROW UP ----------------------------------------------------------------------*/
    ...
    if (keys['ArrowUp'] ) {
      ...
      if(increasingSpeedZup < maxSpeeding){ //increase speed of ball 
        increasingSpeedZup += 0.0000006;
        increasingRotationZup += 0.00006;

      }
      else if(increasingSpeedZup >= maxSpeeding && increasingSpeedZup <= maxSpeeding + 0.004) // to keep making the ball in maximum speed 
      {
    ...
    if(increasingSpeedZup > speedZ ){  //Z for Z-axis
...
/*---------------------------------------------------- ARROW DOWN ----------------------------------------------------------------------*/
    ...
    if (keys['ArrowDown']) {
      ...
      if(increasingSpeedZdown < maxSpeeding){ //increase speed of ball 
        increasingSpeedZdown += 0.0000006;
        increasingRotationZdown += 0.00006;

      }
      else if(increasingSpeedZdown >= maxSpeeding && increasingSpeedZdown <= maxSpeeding + 0.004) // to keep making the ball in maximum speed 
      {
    ...
    if(increasingSpeedZdown > speedZ ){ //Z for Z-axis 
 ...
 if(keys[' ']){
  ...
  /* CAMERA MOVEMENT LOGIC */
    ...
    if (keys['a'] || keys['KeyA'] ) { 
      ...
      else if(increasingSpeedXleftC >= maxSpeeding && increasingSpeedXleftC <= maxSpeeding + 0.004) // to keep making the ball in maximum speed 
      {
    ...
    if (keys['d'] || keys['KeyD'] ) { 
      ...
      else if(increasingSpeedXrightC >= maxSpeeding && increasingSpeedXrightC <= maxSpeeding + 0.004) // to keep making the ball in maximum speed 
      {
    ...
    if (keys['w'] || keys['KeyW']) {
      ...
      else if(increasingSpeedYupC >= maxSpeeding && increasingSpeedYupC <= maxSpeeding + 0.004) // to keep making the ball in maximum speed 
      {
    ...
    if (keys['s'] || keys['KeyS']) {
      ...
      else if(increasingSpeedYdownC >= maxSpeeding && increasingSpeedYdownC <= maxSpeeding + 0.004) // to keep making the ball in maximum speed 
      {
